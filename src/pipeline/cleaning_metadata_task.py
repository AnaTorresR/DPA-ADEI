...
from src.pipeline.cleaning_test_task import TestCleaningTask
from src.utils.general import get_db_credentials
import pickle

# PYTHONPATH='.' luigi --module src.pipeline.cleaning_metadata_task CleaningMetadataTask --ingesta consecutiva --year 2021 --month 04 --day 20 --local-scheduler
...
class CleaningMetadataTask(CopyToTable):
    ...
    def requires(self):
        return TestCleaningTask(self.ingesta, self.year, self.month, self.day)
